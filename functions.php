...
// Adds dynamic titla tag support
...
function followandrew_register_scripts()
{
  ...
  wp_enqueue_script('followandrew-bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js', array(), '1.16.0', true);
